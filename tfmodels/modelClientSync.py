...
def main_runner():
    ...
    for split_point in split_points:
        ...
        write_to_csv(model_name + '_sync' + '.csv', metrics_headers, [frames_to_process, split_point, flops, time, single_frame_time, left_output_size, total_communication_time, single_frame_communication_time, avg_consec_inference_gap, total_left_model_time, total_right_model_time])
        print('-------------------------------------------------------------------------------------------')
